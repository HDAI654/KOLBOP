...
class ASW(QMainWindow):
    ...
    def UI(self):
        ...
        self.info = QPushButton("Add Supplier")
    ...
    def Submit(self):
        ...
        if company_name.strip() == "" or address.strip() == "" or contact_name.strip() == "" or phone.strip() == "" or mobile.strip() == "" or email.strip() == "" or postal_code.strip() == "" or economic_number.strip() == "" or date_time.strip() == "":
            ...
            PRR.Insert("Suppliers", "CompanyName, Address, ContactName, Phone, Mobile, Email, PS, EN, Date", f"'{company_name}', '{address}', '{contact_name}', {phone}, {mobile}, '{email}', {postal_code}, {economic_number}, '{date_time}'")
            self.__cf()