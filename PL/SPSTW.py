...
class SPSTW(QMainWindow):
    def __init__(self, data=[]):
        ...
        self.setStyleSheet("""
            ...
            """)
        self.HEADS = ["Supplier ID", "Name", "Delete Tool", "Edit Tool"]
        self.Data = data
        self.search_combo_index = 0
        self.search_input_text = ""
        self.central_widget = QWidget()
        self.central_layout = QVBoxLayout(self.central_widget)
        self.bp = QPushButton("Buy Suppliers")
    ...
    def ToolbarUI(self):
        ...
        # Entry and Label
        self.PC_label = QLabel("Supplier ID :")
        self.PC_entry = QComboBox()
        
        # Supplier IDs
        pis = PRR.Select("ID, CompanyName", "Suppliers", "true")
    ...
    def SearchToolbarUI(self):
        ...
        self.search_combo.addItems(["Supplier ID", "Name"])
    ...
    def EditToolbarUI(self, data):
        ...
        # Entry and Label
        self.ePC_label = QLabel("Supplier ID :")
        ...
        self.ename_label = QLabel("Supplier Name :")
    ...
    def PC_entry_change(self):
        if self.PC_entry.currentIndex() != 0:
            d = list(PRR.Select("CompanyName", "Suppliers", f"ID={self.PC_entry.currentText().split(' - ')[0].strip()}")[0])
            if d != None:
    ...
    def ePC_entry_change(self):
        if self.ePC_entry.currentIndex() != 0:
            d = list(PRR.Select("CompanyName", "Suppliers", f"ID={self.ePC_entry.currentText().split(' - ')[0].strip()}")[0])
            if d != None:
